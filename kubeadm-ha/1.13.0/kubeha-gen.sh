...
echo """
cluster-info:
  k8s-master-01:        ${CP0_IP}
  k8s-master-02:        ${CP1_IP}
  k8s-master-02:        ${CP2_IP}
  VIP:              ${VIP}
...
kubectl apply -f https://raw.githubusercontent.com/halosky/k8s/master/kubeadm-ha/1.13.0/calico/rbac.yaml
curl -fsSL https://raw.githubusercontent.com/halosky/k8s/master/kubeadm-ha/1.13.0/calico/calico.yaml | sed "s!8.8.8.8!${CP0_IP}!g" | sed "s!10.244.0.0/16!${CIDR}!g" | kubectl apply -f -
...
emailAddress_value              = skycraft888@gmail.com
...
kubectl apply -f https://raw.githubusercontent.com/halosky/k8s/master/kubeadm-ha/1.13.0/plugin/traefik.yaml
kubectl apply -f https://raw.githubusercontent.com/halosky/k8s/master/kubeadm-ha/1.13.0/plugin/metrics.yaml
kubectl apply -f https://raw.githubusercontent.com/halosky/k8s/master/kubeadm-ha/1.13.0/plugin/kubernetes-dashboard.yaml
